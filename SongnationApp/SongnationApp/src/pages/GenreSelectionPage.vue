<template>
    <q-page class="genre-page-container">
...
const genres = ref([
    {id: 1, name: 'Rock', icon: 'amp_stories', slug: 'rock', image: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?auto=format&fit=crop&w=400&q=80'}
])
